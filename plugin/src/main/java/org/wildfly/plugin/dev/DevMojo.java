...
public class DevMojo extends AbstractServerStartMojo {
            ...
            for (;;) {
                ...
                for (WatchEvent<?> event : key.pollEvents()) {
                    ...
                    try {
                        ...
                        boolean reprovisioned = reprovisionAndStart();
    ...
    private Xpp3Dom getWarPluginConfig(final Plugin plugin) {
        ...
        final MojoExecutor.Element e = new MojoExecutor.Element("webappDirectory", resolveWarLocation().toAbsolutePath()
                .toString());
